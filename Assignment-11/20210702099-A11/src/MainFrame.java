...
public class MainFrame extends JFrame{
	...
	private JButton multithreadSearch;
	...
	MainFrame() {
		...
		displayReservations.setPreferredSize(new Dimension(170,24));
		displayServices = new JButton("Display Extra Services");
		displayServices.setPreferredSize(new Dimension(170,24));
		displayResForCity = new JButton("Disp. Res. For City");
		displayResForCity.setPreferredSize(new Dimension(170,24));
		multithreadSearch = new JButton("Multithread Search");
		multithreadSearch.setPreferredSize(new Dimension(170,24));
		
		buttons1stRow.add(displayReservations);
		buttons1stRow.add(displayServices);
		buttons2ndRow.add(displayResForCity);
		buttons2ndRow.add(multithreadSearch);
		...
		terminal.setPreferredSize(new Dimension(500,385));
	...
	public JButton getMultithreadSearch() 	{ return this.multithreadSearch; }
